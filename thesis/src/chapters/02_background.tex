...
invented in the 1980s and was influenced by Prolog.
...
Unlike SQL, Datalog has not been standardized, and several dialects are in use.
...
Due to the use of relational algebra as an \ac{IR} in \ref{ch:implementation},
