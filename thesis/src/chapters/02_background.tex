...
for instance, relational algebra's set difference operator or the advanced
example in \ref{code:mvr-crdt-datalog} due to its lack of negation.
...
Some distributed applications require to continue to operate in the presence of
...
\footnotetext{
	While the documentation is not perfect and the \ac{API} surface quite involved,
