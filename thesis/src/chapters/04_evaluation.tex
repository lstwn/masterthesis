...
updates.
The list \ac{CRDT} presented here resembles \ac{RGA}'s design,
...
Logically, insertions in \ac{RGA} can be represented in a tree structure,
...
\input{figures/bench_near_real_time_kv_store.tex}

\ref{fig:near-real-time-kv-store} shows benchmarks of the simple \ac{MVR} key-value
...
\input{figures/bench_hydration_kv_store.tex}
