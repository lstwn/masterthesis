\begin{figure}[tpb]
	...
	\begin{tikzpicture}
		...
		\node[op,above right=\dist of k10,xshift=\shift] (k11) {\setop{2}{r_1}{k_1}{y_1}}
		edge [pred] (k10);
		\node[op,below right=\dist of k10,xshift=\shift] (k12) {\setop{2}{r_2}{k_1}{z}}
		edge [pred] (k10);

		\node[op, below right=\dist of k11,xshift=\shift] (k13) {\setop{3}{r_1}{k_1}{y_2}}
		edge [pred] (k11) edge [pred] (k12);
		\node[op, right=of k13] (k14) {\setop{4}{r_1}{k_1}{y_3}}
		edge [pred] (k13);
