\begin{figure}[tpb]
	...
	\begin{tikzpicture}
		...
		\begin{scope}[on background layer]
			\draw[parent] (sentinel) to[] (11);
			\draw[parent] (sentinel) to[] (21);
			\draw[parent] (11) to[] (22);
			\draw[parent] (21) to[] (23);
			\draw[parent] (21) to[] (13);
			\draw[parent] (21) to[] (32);
	...
	\end{tikzpicture}
	\caption{
		The tree spanned by RGA's updates.
	}\label{fig:list-crdt}
\end{figure}
